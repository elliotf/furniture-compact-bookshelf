module box_side(dimensions=[0,0],sides=[0,0,0,0],tab_len=10,screw_diam=3,nut_diam=5.5,shoulder_width=3,thickness=5.2) {
  ...
  module add_material_for_slot_side(side) {
    ...
    translate([trans_dist,(shoulder_width)/2-0.05,0])
      cube([len,thickness+shoulder_width+0.1,thickness],center=true);
  }
